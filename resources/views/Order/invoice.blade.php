        ...
        <table class="table table-striped table-borderless border-0 border-b-2">
            ...
            <tr>
                <td><span class="text-sm text-grey-m2 align-middle">To: </span>
                    <span
                        class="text-600 text-110 text-blue align-middle">{{ $data['customer']->first_name . ' ' . $data['customer']->last_name }}</span>
                    <br>
                ...
                <td>
                    ...
                    <br>
                    <span
                        class="text-sm text-grey-m2 align-middle">Billing Address: </span> {{ $data['order']->address['billing'] }}
                    <br>
                    <span
                        class="text-sm text-grey-m2 align-middle">Shipping Address: </span> {{ $data['order']->address['shipping'] }}
                </td>
            </tr>
            </tbody>
        </table>
